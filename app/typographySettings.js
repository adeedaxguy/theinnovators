...
export const TYPOGRAPHY_AREAS = [
  ...
  {
    id: "leader-text",
    name: "Leader Photo Text",
    description: "Leader category labels and names in the Leaders panel.",
    preview: "Academia  Robert Langer",
    size: 15,
    min: 11,
    max: 22,
    weight: 600,
  ...
  },
  {
    ...
    description: "AI for Science, AI for Industries, AI for P, plus their small subtitles.",
    preview: "AI for Science  Connect",
    size: 32,
    min: 18,
    max: 54,
    weight: 560,
